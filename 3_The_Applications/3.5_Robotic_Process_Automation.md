...
## See Also
- [AI-Driven Automation](3.9_AI_Driven_Automation.md) — intelligent document processing, LLM-powered automation
- [Agentic AI Automation](3.10_Agentic_AI_Automation.md) — next-generation agentic RPA
- [Business Process Automation](3.6_Business_Process_Automation.md) — broader BPA context
- [Benchmarks and KPIs](../../2_The_Core/2.2_Benchmarks_and_KPIs.md) — RPA performance metrics
...
The evolution: RPA → Intelligent Automation → Hyperautomation → **Agentic Automation** (see [3.10_Agentic_AI_Automation.md](3.10_Agentic_AI_Automation.md)).
...
See [3.10_Agentic_AI_Automation.md](3.10_Agentic_AI_Automation.md) for full treatment.
